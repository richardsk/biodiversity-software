  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body bgcolor="#FFFFFF">
        ...
        <span class="Title">
          <xsl:value-of select="tapir:response/tapir:metadata/dc:title"/>
        </span>
        <br/>

        <br/>
        <span class="RegularText">
          <xsl:value-of select="tapir:response/tapir:metadata/dc:description"/>
        </span>
        <br/>
        <br/>
        ...
        <span class="RegularText">
          <xsl:choose>
            ...
            <xsl:otherwise>
              unknown (<xsl:value-of select="$language"/>)
            </xsl:otherwise>
          </xsl:choose>
        </span>
        <br/>
        ...
        <xsl:if test="tapir:response/tapir:metadata/dc:rights">
          ...
          <br/>
          <span class="RegularText">
            <xsl:value-of select="tapir:response/tapir:metadata/dc:rights"/>
          </span>
          <br/>
          <br/>
        </xsl:if>
        ...
        <xsl:if test="tapir:response/tapir:metadata/dc:bibliographicCitation">
          ...
          <br/>
          <span class="RegularText">
            <xsl:value-of select="tapir:response/tapir:metadata/dc:bibliographicCitation"/>
          </span>
          <br/>
          <br/>
        </xsl:if>
        ...
        <xsl:if test="tapir:response/tapir:metadata/dc:subject">
          ...
          <br/>
          <span class="RegularText">
            <xsl:value-of select="tapir:response/tapir:metadata/dc:subject"/>
          </span>
          <br/>
        </xsl:if>
        <br/>
        ...
        <xsl:for-each select="tapir:response/tapir:metadata/tapir:relatedEntity">
          ...
          <span class="Section">
            <xsl:value-of select="tapir:entity/tapir:name"/> (<xsl:value-of select="tapir:entity/tapir:acronym"/>)
          </span>
          <br/>
          <br/>
          ...
          <xsl:if test="tapir:entity/tapir:description">
            <span class="RegularText">
              <xsl:value-of select="tapir:entity/tapir:description"/>
            </span>
            <br/>
          </xsl:if>
          <br/>
          <xsl:if test="tapir:entity/tapir:relatedInformation">
            ...
            <a href="{$related-info}">
              <xsl:value-of select="tapir:entity/tapir:relatedInformation"/>
            </a>
            <br/>
            <br/>
          </xsl:if>

          <span class="SubLabel">Roles</span>
          <br/>
          ...
          <span class="SubLabel">Address</span>
          <br/>
          <span class="RegularText">
            <xsl:value-of select="tapir:entity/tapir:address"/>
            <xsl:if test="tapir:entity/geo:Point">
              <br/>(lat: <xsl:value-of select="tapir:entity/geo:Point/geo:lat"/>, long: <xsl:value-of select="tapir:entity/geo:Point/geo:long"/>)
            </xsl:if>
          </span>
          <br/>

          <br/>
          <span class="SubLabel">Contacts</span>
          <br/>
          <xsl:for-each select="tapir:entity/tapir:hasContact">
            <span class="RegularText">
              <xsl:value-of select="vcard:VCARD/vcard:FN"/>
            </span>
            <br/>
            <span class="RegularText">
              <xsl:value-of select="vcard:VCARD/vcard:TITLE"/> (<xsl:for-each select="tapir:role">
                <xsl:value-of select="text()"/>
                <xsl:if test="not(position()=last())">, </xsl:if>
              </xsl:for-each>)
            </span>
            ...
            <br/>
            <span class="RegularText">
              <xsl:value-of select="vcard:VCARD/vcard:TEL"/>
            </span>
            <br/>
        ...
        <hr/>
        <span class="RegularText">
          Created in <xsl:value-of select="tapir:response/tapir:metadata/dct:created"/>
        </span>
        <br/>
        <span class="RegularText">
          Last modified in <xsl:value-of select="tapir:response/tapir:metadata/dct:modified"/>
        </span>
        <br/>
        <br/>
