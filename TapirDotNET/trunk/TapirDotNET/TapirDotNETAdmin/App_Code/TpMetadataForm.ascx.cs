...
namespace TapirDotNET.Controls
{
	...
	public partial class TpMetadataForm : TpWizardForm
	{
		...
		public virtual string GetHtmlLabel(string labelId, bool required)
		{
			...
			html = string.Format("<span class=\"{0}\">{1}<a href=\"help.aspx?name={2}&amp;doc={3}\" {4}>{5}:</a>&nbsp;</span>" + Environment.NewLine, css, note, label, System.Web.HttpUtility.UrlEncode(doc), js, form_label);
