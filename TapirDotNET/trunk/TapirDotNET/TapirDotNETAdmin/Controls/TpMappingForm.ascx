...
<table align="center" width="95%" cellspacing="1" cellpadding="1" bgcolor="#ffffff">
	...
	<tr bgcolor="#ffffff">
		...
		<td width="70%" align="left" nowrap><input type="text" name="load_from_location" value="<%TapirDotNET.TpUtils.GetVar("location", "");%>" size="45">&nbsp;<%=new TapirDotNET.TpHtmlUtils().GetCombo("handler", TapirDotNET.TpUtils.GetVar("handler", ""), this.GetOptions("handler"), false, 0, "") %>
		</td>
