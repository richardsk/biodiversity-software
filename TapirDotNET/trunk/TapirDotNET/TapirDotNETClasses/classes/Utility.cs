...
namespace Utility
{
		...
		internal class OrderedMapSortItem : System.IComparable
		{
			...
			public int CompareTo(object object2)
			{
				...
				if (this._methodName == System.String.Empty && this._instance == null)
				{
                    ...
                    bool matchValue1 = false;
                    if (value1String != null) System.Text.RegularExpressions.Regex.IsMatch(value1String, OrderedMap._NUMBERREGULAREXPRESSION);
                    bool matchValue2 = false;
                    if (value2String != null) System.Text.RegularExpressions.Regex.IsMatch(value2String, OrderedMap._NUMBERREGULAREXPRESSION);
	...
	public class MiscSupport
	{
		...
		{
			TapirDotNET.TpUtils.WriteUTF8(System.Web.HttpContext.Current.Response, message);
