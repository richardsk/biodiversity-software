...
//				}
		...
		public virtual void  Header()
		{
			...
			{
				h += "\n<custom><skin xmlns=\"http://rs.tdwg.org/tapir/1.0/skin\">" + TpConfigManager.TP_SKIN + "</skin></custom>";
			}
			
			h += "\n</header>";
			
			TpUtils.WriteUTF8(HttpContext.Current.Response, h);
		...
		public virtual void  NamespaceDeclarations()
		{
			...
			TpUtils.WriteUTF8(HttpContext.Current.Response, ns_declarations);
			
			if (!Utility.VariableSupport.Empty(locations))
			{
				TpUtils.WriteUTF8(HttpContext.Current.Response, " " + TpConfigManager.TP_XSI_PREFIX + ":schemaLocation=\"" + locations.Trim(new char[]{' ', '\t', '\n', '\r', '0'}) + "\"");
			}
		...
		public virtual void  XmlHeader()
		{
			...
			// Start the response
            TpUtils.WriteUTF8(HttpContext.Current.Response, TpUtils.GetXmlHeader());
			...
			if (this.mXslt != null)
			{
				...
				TpUtils.WriteUTF8(HttpContext.Current.Response, "\n");
				TpUtils.WriteUTF8(HttpContext.Current.Response, "<?xml-stylesheet type=\"text/xsl\" href=\"" + this.mXslt + "\"?>");
			}
		}// end of member function XmlHeader
		
		public virtual void  Footer()
		{
			TpUtils.WriteUTF8(HttpContext.Current.Response, new TpDiagnostics().GetXml());
