...
namespace TapirDotNET 
{
	...
	public class TpConfigManager
	{
        ...
        public static string TP_WSDL_DIR = "wsdl";
        ...
        public static bool TP_SQL_DELIMIT_NAMES = true;
        ...
        public static string DC_CONTENT_UNAVAILABLE = "CONTENT UNAVAILABLE";
		...
		public static void LoadConfig()
		{
            ...
            TP_WSDL_DIR = GetConfigString("TP_WSDL_DIR", TP_WSDL_DIR);
            ...
            TP_SQL_DELIMIT_NAMES = GetConfigBool("TP_SQL_DELIMIT_NAMES", TP_SQL_DELIMIT_NAMES);
