...
namespace LSIDFramework
{
  ...
  public class PublishViaMIME : SoapExtension 
  {
    ...
    public override void ProcessMessage(SoapMessage message) 
    {
      switch (message.Stage) 
      {
        ...
        case SoapMessageStage.BeforeDeserialize:     
          ...
          {
			  newStream = ConvertSoapEnvelope(oldStream, ref SOAPenvelope);

            //make sure we reset the request's content type, since it
            //is no longer in "Multipart/Related" form
            message.ContentType = HTTPConstants.XML_CONTENT;
          }
    ...
    ///</summary>
    ///<param name='input'>The request stream.  Also depends on the 
    ...
    ///</returns>
    //============================================================
    public void resolveContentRefs(Stream MIMEstream, ref String envelope)
    {
      string contID;
      string content;
