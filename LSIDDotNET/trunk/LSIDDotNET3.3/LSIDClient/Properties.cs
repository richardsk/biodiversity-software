...
{	
    ...
    public class Properties 
    {
		...
		{
			string props = "";
			foreach (Property p in _propertyList)
			{
				props += "<" + WSDLConstants.ANB + ":" + WSDLConstants.PROPERTY_ELT + ">";
				props += "<" + WSDLConstants.NAME_ELT + ">" + p.getName() + "</" + WSDLConstants.NAME_ELT + ">";
				props += "<" + WSDLConstants.VALUE_ELT + ">" + p.getValue() + "</" + WSDLConstants.VALUE_ELT+ ">";
				props += "</" + WSDLConstants.ANB + ":" + WSDLConstants.PROPERTY_ELT + ">\r\n";
			}
			return props;
		}
