 ...
 */
	public abstract class BaseServlet  
	{
		...
		public virtual void init() 
		{
			try 
			{
				String clientHome = ConfigurationManager.AppSettings.Get(LSIDResolverConfig.LSID_CLIENT_HOME);
				String configLocation = ConfigurationManager.AppSettings.Get(ServiceConfigurationConstants.RSDL_LOCATION);
